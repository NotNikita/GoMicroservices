...
const file_logs_proto_rawDesc = "" +
	...
	"\n" +
	"LogService\x12.\n" +
	"\aLogInfo\x12\x10.logs.LogRequest\x1a\x11.logs.LogResponseB\aZ\x05/logsb\x06proto3"
...
var file_logs_proto_depIdxs = []int32{
	0, // 0: logs.LogService.LogInfo:input_type -> logs.LogRequest
	1, // 1: logs.LogService.LogInfo:output_type -> logs.LogResponse
